...
public final class FileUtil {
     ...
     * @throws InvalidParameterException if you specify an invalid parameter
     */
    public static String[] getFilesInDirectory(@NotNull token mode, String directory, String fileMask) throws IOException {
    ...
    public static @Nullable File fileChooser(String extensionFilter) {
        ...
        class CustomFilter extends FileFilter {
            ...
            public @NotNull String getDescription() {
                return extensionFilter.toLowerCase()+" files";
            }

            private @NotNull String getExtension(@NotNull File f) {
                String s = f.getName();
                int i = s.lastIndexOf('.');
                if (i > 0 && i < s.length() - 1) {
