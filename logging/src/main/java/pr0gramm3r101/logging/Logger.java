...
import pr0gramm3r101.util.console.ConsoleColor;
...
import static pr0gramm3r101.logging.Loglevel.*;
import static pr0gramm3r101.util.io.FileUtil.token.APPEND;
import static pr0gramm3r101.util.io.FileUtil.token.WRITE;
...
public class Logger {
     ...
     * if the loglevel is not {@link Loglevel#ERROR} or {@link Loglevel#FATAL}.
     ...
     * @param level The loglevel. Loglevels can be found in the enum {@link Loglevel}.
     ...
     * @see Logger#writeLogMsg
     */
    public void log(Loglevel level, String message, String displayMessage) {
     ...
     * <br/>
     * It will print a message to {@link System#out}
     * if the loglevel is not {@link Loglevel#ERROR} or {@link Loglevel#FATAL}an.
     * Otherwise, it will print the message to {@link System#err}.
     * <br/>
     * The message will include the current date & time, loglevel and the message.
     * <br/>
     ...
     * @see Logger#constructLogMsg
     */
    public void log(Loglevel level, String message, token displayMessage) {
        String msg = constructLogMsg(level, message);
        writeLogMsg(msg);
     ...
     * <br/>
     * It will print the message to {@link System#err} if the loglevel is {@link Loglevel#ERROR} or {@link Loglevel#FATAL}.
     * <br/>
     ...
     * <br/>
     * {@link Loglevel#INFO} - <code><font color=white>White</font></code>
     * <br/>
     * {@link Loglevel#DEBUG} - <code><font color=gray>Gray</font></code>
     * <br/>
     * {@link Loglevel#WARN} - <code><strong><font color=yellow>Bold Yellow</font></strong></code>
     * <br/>
     * {@link Loglevel#ERROR} - <code><font color=red>Red</font></code>
     * <br/>
     * {@link Loglevel#FATAL} - <code><strong><font color=red>Bold Red</font></strong></code>
     * <br/>
     ...
     * @see ConsoleColor
     */
    private void printLogMsg(@NotNull Loglevel level, String msg) {
        if (colorOutput) {
            switch (level) {
                case INFO:
     ...
     */
    private static @NotNull String constructLogMsg(@NotNull Loglevel level, String message) {
    ...
    /**
     * Sets the default logger output stream {@link Loglevel}.
     * @param level The loglevel. Cannot be <code>null</code>.
     * @throws NullPointerException if the {@link Loglevel} is <code>null</code>
     */
    public void setDefaultStreamLoglevel(@NotNull Loglevel level) {
    ...
    public static class LoggerOutputStream extends OutputStream {
        ...
        /**
         * The default logger {@link Loglevel}.
         */
         ...
         */
        public LoggerOutputStream(Logger logger, Loglevel defaultLoglevel) {
         ...
         */
        public LoggerOutputStream(@NotNull Logger logger, @NotNull Loglevel defaultLoglevel, @Nullable token msg) {
            this.logger = logger;
         ...
         */
        @Contract(pure = true)
        private byte[] convertBytesToPrimitiveType(Byte[] bytes) {
        ...
        /**
         * @return The default {@link Loglevel}.
         */
        ...
        /**
         * Sets the default {@link Loglevel}.
         * @param level The loglevel. Cannot be <code>null</code>.
